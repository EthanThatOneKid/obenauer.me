...
build our relationship with the [[tools|tools]] we use daily.
...
> lives, turning scattered data into an interconnected, navigable garden.

Everything rests on the interplay between the [[graph]], the [[views]] we
construct to observe it, and the [[assets]] that inhabit it.
