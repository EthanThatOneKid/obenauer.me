...
> # reference
> 
> A [[references|reference]] is the connective tissue of a future [[items|itemized-os]],
> transforming static files into a dynamic, interconnected [[graph-os]]. By
> treating every digital artifact—whether an email, task, or note—as an [[items|item]],
