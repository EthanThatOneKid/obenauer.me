...
monolithic applications toward [[atomized-apps]] and [[user-created-views]], we
can compose fluid experiences that respect the underlying [[graph-os]]. When
interfaces become [[swappable-views]], they shift from static containers into
dynamic tools that prioritize [[user-agency]] and semantic meaning over
