...
[[user-agency]] represents the fundamental freedom to redesign, remix, and reconfigure our digital environments to reflect our specific [[thinking]]. Currently, our [[interfaces|interface]] [[design]] is constrained by a false dichotomy where we can modify content but remain powerless to alter the [[structure]] or [[context]] provided by others. True [[agency]] means treating the modification of data and the remodeling of [[views]] as the same class of action—making software truly [[malleable-software]].
