...
[[human-computer-relationship]], moving away from rigid, pre-packaged software
toward a landscape where individuals define how they interact with their digital
world. By leveraging [[atomized-apps]] and [[item-based-computing]], users can
...
compose workflows through [[gestural-view-construction]]. By treating the [[item|item]]
as the core primitive, we enable an ecosystem where [[swappable-views]] allow
for infinite experimentation with how we organize and perceive our work.
